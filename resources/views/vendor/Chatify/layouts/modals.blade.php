  ...
  <div class="app-modal" data-name="delete">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="delete" data-modal='0'>
              <div class="app-modal-header">¿Estas seguro de borrar esto?</div>
              <div class="app-modal-body">No puedes deshacer esta acción</div>
              <div class="app-modal-footer">
                  <a href="javascript:void(0)" class="app-btn cancel">Cancelar</a>
                  <a href="javascript:void(0)" class="app-btn a-btn-danger delete">Borrar</a>
              </div>
          </div>
      </div>
  </div>
      ...
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  @csrf
                  {{-- <div class="app-modal-header">Actualizar tus configuraciones de perfil</div> --}}
                  <div class="app-modal-body">
                      ...
                      <p class="divider"></p>
                      {{-- <p class="app-modal-header">Cambiar {{ config('chatify.name') }} Color</p> --}}
